...
def alec():
    ...
    def super_hard_math_question():
        ...
        print(Fore.LIGHTYELLOW_EX +  "   If a hen and a half lay an egg and a half in a day and a half, \n   how many eggs will half a dozen hens lay in half a dozen days?\n")
        print(Fore.GREEN + " You're stunned, but are determined to get this right. Do you answer")
    ...
    def downstairs():
        ...
        if initial_answer == "a":
            ...
            if answer == "a":
                ...
                print("You've just entered the room. You see a piece of paper on a table with the words \n TELL THEM THAT YOU 'hatebricks' WHEN THEY ASK YOU ABOUT BRICKS! \n This is VERY important.")
                return super_hard_math_question()
        elif initial_answer == "c":
            ...
            if answer == "a":
                ...
                print("'Now we're talking' He says. 'TELL THEM THAT YOU 'hatebricks' WHEN THEY ASK YOU ABOUT BRICKS!' \n")
                print("You thank him and head back upstairs!\n")
                return super_hard_math_question
            elif answer == "c":
                print("'Excellent. I was hoping you'd beg.' He said. 'Here's the secret: TELL THEM THAT YOU 'hatebricks' WHEN THEY ASK YOU ABOUT BRICKS! \n This is VERY important.\n")
                print("You thank him and head back upstairs!\n")
                return super_hard_math_question()
    ...
    def egg_question():
        ...
        initial_answer = input("     a) Scrambled \n     b) Fried \n     c) Raw\n\n     Choose  A, B or C:  ").lower()
        if initial_answer == "a":
            ...
            answer = input("     a) I like them wet \n     b) Gotta cook them up!\n\n     Choose  A or B:  ")
            if answer == "a":
