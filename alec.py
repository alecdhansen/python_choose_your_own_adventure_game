def alec():
    ...
    def brick_question():
        ...
        if initial_answer == "a":
            print("Interesting answer! I like that. You're hired!")
    ...
    def super_hard_math_question():
        ...
        print("You're stunned, but are determined to get this right. Do you answer")
        initial_answer = input(
            "\n a) 1 dozen \n b) 2 dozen \n c) 3 dozen \n d) A hen doesn't lay eggs!"
        ).lower()
        if initial_answer == "a":
            print("Nope. Wrong. Not even close.")
            return brick_question()
        elif initial_answer == "b":
            print("That's correct! Wow you are VERY smart. I'll keep this in mind.")
            return brick_question()
        elif initial_answer == "c":
            print(
    ...
    def downstairs():
        ...
        if initial_answer == "a":
            ...
            print("Of course you want to know what this information might be. Do you")
            answer = input(
                "a) Simply ask him what the info is \n b) Pull out a $100 bill and offer it to him for the info \n c) Get down on your knees and beg"
            ).lower()
            if answer == "a":
                print(
                    "'You think I would just give that info away??' He says. \n This isn't good. He punches you in the face so hard your nose breaks. \n There's no way you can complete this interview now.\n"
                )
                return dejected_walk_of_shame
            elif answer == "b":
                print(
    ...
    def egg_question():
        ...
        print("First question! How do you like your eggs?\n")
        initial_answer = input("a) Scrambled \n b) Fried \n c) Raw \n").lower()
        if initial_answer == "a":
            print(
                "Scrambled! Of course! So you're saying you like to conform to the rest of the \n population and there's nothing special about you? \n "
            )
            answer = input(
                "Do you at least put ketchup on your eggs? a) yes \n b) no \n"
            ).lower()
            if answer == "a":
                print(
