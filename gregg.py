...
def gregg():
    ...
    def star_trek_or_star_wars():
        ...
        print(Fore.CYAN + "<>" * 73)
        print(
            "\n Gregg looks at you and smiles. This is my favorite part of the interview process.\n"
        )
        print(
            Fore.LIGHTYELLOW_EX
