...
def interview():
    ...
    print()
    if time < datetime(2022, 10, 10, 9, 00, 0):
        ...
        return alec()
    # elif time <= datetime(2022, 10, 10, 9, 00, 0):
        # print("\n     The receptionist says you are on time for you interview with Jonathan. \n     Please have a seat for a moment and I will page him for you.")
        # return jonathan()
    # elif time > datetime(2022, 10, 10, 9, 30, 0) & time <= datetime(2022, 10, 10, 10, 00, 0):
    #     print("\n     You finally made it to your interview! Your interviewer will be Corey. Watch out though! He will ask some random questions")
    #     return corey()
    # elif time > datetime(2022, 10, 10, 9, 00, 0):
    #     print("gregg")
    
    # interviewers = ["jonathan"]
#   "gregg, jonathan"]
...
def cod():
    ...
    if initial_answer == "a":  # Quit and move onto getting ready?
        ...
        print(Fore.BLUE + "<>" * 73)
        print()
        print(Fore.GREEN + "  You decided to play just one game and be responsible and get ready for your interview! Will you:\n \n    a) Go to the kitchen to eat breakfast? \n    b) Take a shower?  "
        )
        print("\n    Current Time: ", time.time(),"AM")
        answer = input("\n  Choose -  A or B:  ").lower()
